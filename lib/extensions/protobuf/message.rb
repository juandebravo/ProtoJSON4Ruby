  ...
  class Message
    ...
    def serialize_to_hash
      ...
      self.each_field do |field, value|
        # create a vector if field is repetead
    ...
    def serialize_to_string(string='')
      ...
      when EncodingType::JSON # JSON format
        serialize_to_json
        ...
        if field.nil?
          ...
          value.each{|val|
            ...
            if field.is_a?(Protobuf::Field::MessageField)
              ...
              val = instance.parse_from_json(val)
            end
          ...
          if field.is_a?(Protobuf::Field::MessageField)
            instance = field.type.new
            value = instance.parse_from_json(value)
          end
    ...
    def parse_from_string(string)
      ...
      when EncodingType::JSON
        parse_from_json(string)
